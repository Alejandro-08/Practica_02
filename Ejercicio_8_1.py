...
"""En el ultimo metodo de la clase ElerctricCar se muestra de parte del objeto
llamado mu_tesla, se manda a llamar y manda un mensaje de que el carro esta
descargado, y ya esta cargandose"""